...
public class StaffTask {
    ...
    public void updateMeta(ItemStack item, ItemMeta meta, Player player) {
        ...
        int uses_Left = max_Uses.getOrDefault(getStorageKey(), PersistentDataType.INTEGER, FNAmplifications.getConfigManager().getCustomConfig("staffs-settings").getInt(this.getId() + "." + "max-uses"));
