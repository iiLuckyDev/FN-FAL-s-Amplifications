...
public class ElectricIngotCondenser extends AContainer implements RecipeDisplayItem {
    ...
    static {
        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_17)) {
            ...
            VERSIONED_ITEMSTACK_COPPER = new SlimefunItemStack(SlimefunItems.COPPER_INGOT, 2).item();
        }
    }
    ...
    protected void registerDefaultRecipes() {
        ...
        registerRecipe(12, new ItemStack[]{new SlimefunItemStack(SlimefunItems.BRONZE_INGOT, 1).item(), VERSIONED_ITEMSTACK_COPPER},
                new ItemStack[]{new SlimefunItemStack(SlimefunItems.CORINTHIAN_BRONZE_INGOT, 1).item()});
        registerRecipe(12, new ItemStack[]{new ItemStack(Material.IRON_INGOT, 1), VERSIONED_ITEMSTACK_COPPER},
                new ItemStack[]{new SlimefunItemStack(SlimefunItems.NICKEL_INGOT, 1).item()});
        registerRecipe(12, new ItemStack[]{new SlimefunItemStack(SlimefunItems.NICKEL_INGOT, 1).item(), VERSIONED_ITEMSTACK_COPPER},
                new ItemStack[]{new SlimefunItemStack(SlimefunItems.COBALT_INGOT, 1).item()});
        registerRecipe(12, new ItemStack[]{new SlimefunItemStack(SlimefunItems.ALUMINUM_INGOT, 1).item(), VERSIONED_ITEMSTACK_COPPER},
                new ItemStack[]{new SlimefunItemStack(SlimefunItems.DURALUMIN_INGOT, 1).item()});
    ...
    public ItemStack getProgressBar() {
        return new SlimefunItemStack(FNAmpItems.CONDENSER_PART, 1).item();
    }
}
