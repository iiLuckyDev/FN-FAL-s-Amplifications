...
public abstract class AbstractJukeBox extends SlimefunItem implements InventoryBlock, EnergyNetComponent {
    ...
    public ItemStack NOT_OPERATING = custom(Material.ORANGE_STAINED_GLASS_PANE,
            "&cNot Operating!",
            "&eClick Play Button"
    );

    public ItemStack OPERATING = custom(Material.GREEN_STAINED_GLASS_PANE,
            "&cOperating!"
    );

    public ItemStack NO_POWER = custom(Material.RED_STAINED_GLASS_PANE,
            "&cNo Power!",
            "&ePower it up first!"
    );

    public ItemStack NOT_RUNNING = custom(Material.YELLOW_STAINED_GLASS_PANE,
            "&cNot Running",
            "&eToggle it on first"
    );

    public ItemStack TOGGLED_ON = custom(Material.BLUE_STAINED_GLASS_PANE,
            "&dToggle:",
            "&eEnabled",
            "Click to change"
    );

    public ItemStack TOGGLED_OFF = custom(Material.WHITE_STAINED_GLASS_PANE,
            "&dToggle:",
            "&eDisabled",
            "Click to change"
    );

    public ItemStack PLAY = custom(head("cecd041f628c005a690fc6b8237e7311bb7c3b3aac10539fefe396a4c7c783e7"),
            "&dStop");

    public ItemStack STOP = custom(head("fa8f6b131ef847d9160e516a6f44bfa932554d40c18a81796d766a5487b9f710"),
            "&dPlay");

    public ItemStack PREVIOUS = custom(head("32ff8aaa4b2ec30bc5541d41c8782199baa25ae6d854cda651f1599e654cfc79"),
            "&dPrevious disc");

    public ItemStack NEXT = custom(head("aab95a8751aeaa3c671a8e90b83de76a0204f1be65752ac31be2f98feb64bf7f"),
            "&dNext disc");
